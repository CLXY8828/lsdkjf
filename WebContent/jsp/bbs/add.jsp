...
<!--
	...
	function saveObj(){ //保存修改对象
		document.editForm.action="<%=request.getContextPath()%>/bbs!add.action" 
...
<TABLE class=bgtable cellSpacing=1 cellPadding=2 width="98%" align=center border=1>
	...
	<TBODY>
		<TR>
			...
			<TD colSpan=7><INPUT maxLength=200 name="bbs.content"></TD>
		</TR>
		<TR>
			<TD align=middle>时&nbsp;&nbsp;&nbsp;间</TD>
			<TD colSpan=7><INPUT maxLength=200 name="bbs.inTime"></TD>
		</TR>
